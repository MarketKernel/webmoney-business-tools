namespace WebMoney.Services.Migrations.SqlServer
{
    ...
    public partial class V2 : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.Account", "SecretKeyX20", c => c.String());
            AddColumn("dbo.Certificate", "OrganizationCorrAccount", c => c.String());
        ...
        public override void Down()
        {
            ...
            AddColumn("dbo.Certificate", "OrganizationCorrespondentAccount", c => c.String());
