...
SET OUT_DIR=Output
SET OUT_FILE=WMBusinessTools.Setup-x32.msi
...
candle.exe Components.wxs -dPlatform="x86" -out %OUT_DIR%\Components.wixobj
candle.exe Product.wxs -dPlatform="x86" -out %OUT_DIR%\Product.wixobj
