...
namespace WMBusinessTools.Extensions.StronglyTypedWrappers
{
    ...
    {
        public ComboBoxTemplate Control1Provider => (ComboBoxTemplate) GetControlTemplate("Provider");

        public TextBoxWithButtonTemplate Control2PathToDatabase =>
            (TextBoxWithButtonTemplate) GetControlTemplate("PathToDatabase");
        ...
        public TextBoxTemplate Control5PasswordConfirmation =>
            (TextBoxTemplate) GetControlTemplate("PasswordConfirmation");
