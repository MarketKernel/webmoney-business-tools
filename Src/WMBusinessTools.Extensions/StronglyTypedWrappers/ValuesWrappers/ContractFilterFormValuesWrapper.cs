...
{
    internal sealed class ContractFilterFormValuesWrapper : StronglyTypedValuesWrapper
    {
        ...
        public ContractFilterFormValuesWrapper()
        {
        }

        public ContractFilterFormValuesWrapper(List<object> values)
        {
            if (null == values)
